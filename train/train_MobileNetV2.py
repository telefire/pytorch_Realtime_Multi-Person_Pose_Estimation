...
from lib.network.rtpose_mobilenetV2 import get_model
...
ANNOTATIONS_TRAIN = ANNOTATIONS_VAL = [os.path.join(DATA_DIR, 'annotations', item) for item in ['person_keypoints_train2017.json']]
...
model_save_filename = './mobilenet_v2_best_pose.pth'
